...
export async function addressesPatchCustomersCustomerIdAddressesAddressId(
  ...
  Result<
    ...
    | errors.PatchCustomersCustomerIdAddressesAddressIdResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const context = {
    operationID: "patch_/customers/{customer_id}/addresses/{address_id}",
    oAuth2Scopes: [],
