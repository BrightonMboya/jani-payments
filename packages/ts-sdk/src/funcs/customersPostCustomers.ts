...
export async function customersPostCustomers(
  ...
  Result<
    ...
    | errors.PostCustomersResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostCustomersRequestBody$outboundSchema.optional().parse(
        value,
      ),
  ...
  >(
    ...
    M.jsonErr(400, errors.PostCustomersResponseBody$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
