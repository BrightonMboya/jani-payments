 ...
 */
export type PostDiscountsResponseBodyData = {
  error: string;
  message: string;
};
 ...
 * Failed to create discount
 */
export class PostDiscountsResponseBody extends Error {
  error: string;

  /** The original data that was passed to this error instance. */
  data$: PostDiscountsResponseBodyData;

  constructor(err: PostDiscountsResponseBodyData) {
    ...
    this.name = "PostDiscountsResponseBody";
  }
}
...
> = z.object({
  ...
  .transform((v) => {
    return new PostDiscountsResponseBody(v);
  });
...
export const PostDiscountsResponseBody$outboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  PostDiscountsResponseBody
> = z.instanceof(PostDiscountsResponseBody)
  .transform(v => v.data$)
  .pipe(z.object({
    error: z.string(),
    message: z.string(),
