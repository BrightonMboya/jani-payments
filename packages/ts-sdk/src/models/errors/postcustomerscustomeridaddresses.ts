 ...
 */
export type PostCustomersCustomerIdAddressesResponseBodyData = {
  message: string;
  error: string;
};
 ...
 * Failed to create address
 */
export class PostCustomersCustomerIdAddressesResponseBody extends Error {
  error: string;

  /** The original data that was passed to this error instance. */
  data$: PostCustomersCustomerIdAddressesResponseBodyData;

  constructor(err: PostCustomersCustomerIdAddressesResponseBodyData) {
    ...
    this.name = "PostCustomersCustomerIdAddressesResponseBody";
  }
}
...
export const PostCustomersCustomerIdAddressesResponseBody$inboundSchema:
  ...
  > = z.object({
    ...
    .transform((v) => {
      return new PostCustomersCustomerIdAddressesResponseBody(v);
    });
...
export const PostCustomersCustomerIdAddressesResponseBody$outboundSchema:
  z.ZodType<
    ...
    z.ZodTypeDef,
    PostCustomersCustomerIdAddressesResponseBody
  > = z.instanceof(PostCustomersCustomerIdAddressesResponseBody)
    .transform(v => v.data$)
    .pipe(z.object({
      message: z.string(),
      error: z.string(),
